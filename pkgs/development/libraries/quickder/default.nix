...
#weerweg#   installPhase = ''
#weerweg#     mkdir -p $out/include/quick-der $out/lib $out/lib64 $out/share/ARPA2CM/toolchain $out/share/doc/quick-der $out/share/Quick-DER/cmake
#weerweg#     ls -R
#weerweg#     cmake ${toString cmakeFlags} .
#weerweg#     cp lib/lib* $out/lib
#weerweg#     cp -R rfc/quick-der/* arpa2/quick-der/* ../include/quick-der/*.h $out/include/quick-der
#weerweg#     cp -R CMakeFiles/*.cmake $out/share/Quick-DER/cmake
#weerweg#   '';
